...
"""La fonction plot_data est utilisee pour afficher les donnees audio capturees
   et leur transformee de Fourier (FFT) afin d'analyser le frequence principale 
"""
